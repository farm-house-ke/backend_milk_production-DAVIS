...
from .serializers import AnimalSerializer, PurchasedSerializer, LocallyServicedSerializer, AIPredeterminedServicedSerializer, AInotPredeterminedServicedSerializer
